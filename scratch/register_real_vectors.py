...
JSON_FACE_VECTORS = os.path.join(PROJECT_ROOT, "missing_person_db", "face_vectors.json")
...
def process_and_register_real_vectors():
    ...
    upload_files = sorted(glob.glob(os.path.join(PROJECT_ROOT, "data", "uploads", "*.jpg")))
    ...
    for idx, case in enumerate(cases):
        ...
        # Copy image file to data/faces/ so load_image_safely can find it
        target_face_path = os.path.join(PROJECT_ROOT, "data", "faces", f"case_{case_id}.jpg")
